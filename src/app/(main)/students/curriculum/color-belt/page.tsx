...
const curriculumEntries: CurriculumEntry[] = [
  ...
  { level: "Advanced", levelSubtitle: "Blue -> Brown -> Red", levelAccent: skillLevelPalette.advanced.accent, levelAccentBg: skillLevelPalette.advanced.accentBg, cycle: "3", beltName: "Red", beltDotClass: "bg-red-600", poomsae: "Taegeuk 8", poomsaeFullName: "Taegeuk 8 Jang", poomsaeKorean: "태극 팔장", poomsaeIndex: 8, weapon: "SJB", oneStep: "Red", handTech: "49-52", board: "Jump Reverse Side Kick" },
];
