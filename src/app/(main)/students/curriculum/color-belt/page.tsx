...
const curriculumEntries: CurriculumEntry[] = [
  ...
  { level: "Beginner", levelSubtitle: "White -> Orange -> Yellow", levelAccent: skillLevelPalette.beginner.accent, levelAccentBg: skillLevelPalette.beginner.accentBg, cycle: "2", beltName: "Orange", beltDotClass: "bg-orange-400", poomsae: "Taegeuk 1", poomsaeVideoId: "n5Q-g0uUj3c", weapon: "JB", oneStep: "Orange", handTech: "7-12", board: "Front Kick" },
